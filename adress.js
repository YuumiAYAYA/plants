export default class Adress{
    ...
    draw(){
        const wrapper = document.querySelector('.cities');
            ...
            newCity.textContent = this.city;
            wrapper.append(newCity);

    }
    hide() {
        const ayaya = document.querySelector('.cities');
        ayaya.classList.add('cities__hidden');
        ayaya.classList.remove('cities__visible');
        
    }

    unhide() {
        const ayaya = document.querySelector('.cities');
        ayaya.classList.remove('cities__hidden');;
        ayaya.classList.add('cities__visible');
    }
